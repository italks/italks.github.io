# Vue 3 新纪元：思维模型的转变 (Vue 3 全景攻略 - 01)

> **摘要**：本篇作为 Vue 3 全景攻略的开篇，深入探讨从 Options API 到 Composition API 的思维模型转变。我们将剖析 Vue 2 逻辑碎片化的痛点，揭示组合式 API 如何通过高内聚、低耦合的代码组织方式提升开发体验，并对比 `<script setup>` 语法糖带来的性能与效率提升，助你建立全新的前端开发视角。
